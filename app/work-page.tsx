...
export function WorkPage({ label, title, description, services, tone }: WorkPageProps) {
  return <main className="detailPage">
    ...
    <header className="detailNav"><a className="brand" href="/" aria-label="KSP Vision home"><span>KSP</span> VISION</a><nav className="mainNav" aria-label="Main navigation"><a href="/kspfilms">KSP Films</a><a href="/brand-documentary">Brand / Doc</a><a href="/weddings">Weddings</a><a href="/booking" className="navCta">Book</a></nav></header>
